        ...
        <div class="relative pt-2">
          ...
          <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
            ...
            <div class="text-center sm:text-right space-y-1.5">
              ...
              <h3 class="text-xl sm:text-2xl font-black text-[#00284d] dark:text-white transition-colors tracking-tight">
                شركاء المسيرة والتحالفات الاستراتيجية
              </h3>
              <p class="text-slate-500 dark:text-slate-400 text-xs sm:text-sm leading-relaxed transition-colors">
