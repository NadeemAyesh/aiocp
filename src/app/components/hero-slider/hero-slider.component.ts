...
@Component({
  ...
  template: `
    ...
    <section
      id="hero"
      class="relative overflow-hidden bg-[#001428] text-white select-none border-b border-white/10 min-h-screen flex flex-col justify-center py-10 sm:py-14 lg:py-16"
    ...
    >
      ...
      <div class="absolute bottom-0 inset-x-0 w-full pointer-events-none z-0 overflow-hidden select-none">
        <div class="relative w-full h-[120px] sm:h-[155px] md:h-[185px] lg:h-[220px]">
          <svg
            class="w-full h-full transition-opacity duration-700 opacity-40 sm:opacity-55 dark:opacity-65 mix-blend-overlay pointer-events-none"
          ...
          >
            <defs>
              <linearGradient id="skylineGradLight" x1="0" y1="0" x2="0" y2="1">
                ...
                <stop offset="50%" stop-color="#0284c7" stop-opacity="0.40" />
                <stop offset="100%" stop-color="#001428" stop-opacity="0.65" />
              </linearGradient>
              ...
              <linearGradient id="skylineGradDark" x1="0" y1="0" x2="0" y2="1">
                ...
                <stop offset="100%" stop-color="#001428" stop-opacity="0.75" />
              </linearGradient>
            ...
            <g
              class="fill-[url(#skylineGradDark)] stroke-[#38bdf8]/35 stroke-[0.75]"
              fill-rule="evenodd"
            >
            ...
            <g transform="translate(1240, 10)">
              <circle r="16" fill="#f4921e" fill-opacity="0.2" />
              <circle r="7" fill="#ffb703" filter="url(#goldenAura)" fill-opacity="0.6" />
              <circle r="2.5" fill="#ffffff" fill-opacity="0.8" />
            </g>
            ...
            <g transform="translate(186.65, 298)">
              <circle r="14" fill="#f4921e" fill-opacity="0.2" />
              <circle r="6" fill="#ffb703" filter="url(#goldenAura)" fill-opacity="0.6" />
              <circle r="2" fill="#ffffff" fill-opacity="0.8" />
            </g>
          ...
          <div class="absolute bottom-0 inset-x-0 h-20 bg-gradient-to-t from-[#001428] via-[#001428]/60 to-transparent pointer-events-none"></div>
        </div>
      </div>
      ...
      <div class="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-20">
        ...
        <div dir="rtl" class="w-full lg:max-w-2xl xl:max-w-3xl lg:mr-0 lg:ml-auto text-right space-y-5 sm:space-y-6 lg:space-y-7">

          <!-- 1. Atelier Chic Eyebrow Badge -->
          <div class="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-[#f4921e]/15 border border-[#f4921e]/35 backdrop-blur-md shadow-md mb-1">
            <span class="w-2 h-2 rounded-full bg-[#f4921e] animate-ping"></span>
            <span class="text-[11px] sm:text-xs font-bold text-[#f4921e] dark:text-[#ffb703]">
              {{ activeSlide.badge }}
            </span>
          </div>
          ...
          <div class="space-y-2 sm:space-y-3">
            <h1 class="text-2xl sm:text-3xl md:text-[36px] lg:text-[40px] xl:text-[44px] font-black text-white leading-[1.35] sm:leading-[1.4] md:leading-[1.42] tracking-tight drop-shadow-md">
              {{ activeSlide.title }}
              <span class="block text-[#f4921e] mt-2 sm:mt-2.5 drop-shadow-sm">
                {{ activeSlide.titleHighlight }}
              </span>
            </h1>
            <!-- Minimalist Accent Rule -->
            <div class="w-16 sm:w-20 h-[3.5px] bg-gradient-to-l from-[#f4921e] to-[#ffb703] rounded-full mt-3.5 sm:mt-4"></div>
          </div>

          <!-- 3. Refined Narrative Description -->
          <p class="text-sm sm:text-base lg:text-[17px] text-slate-100/90 leading-[1.8] sm:leading-loose font-medium max-w-xl lg:max-w-2xl drop-shadow-sm py-1">
            {{ activeSlide.description }}
          </p>

          <!-- 4. Conversion Action CTAs (Primary Glow Pill + Secondary Glass Action) -->
          <div class="pt-2 sm:pt-3 flex flex-wrap items-center gap-3 sm:gap-3.5">
            <!-- Primary CTA Button -->
            <a
              [href]="activeSlide.primaryCtaLink"
              class="group inline-flex items-center justify-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 bg-gradient-to-r from-[#f4921e] to-[#de7c0d] hover:from-[#ff9f30] hover:to-[#f4921e] text-[#001f3b] font-bold text-xs sm:text-sm rounded-lg sm:rounded-xl transition-all duration-300 shadow-md hover:shadow-orange-500/25 hover:-translate-y-0.5 cursor-pointer"
            >
            ...
            <button
              ...
              class="inline-flex items-center justify-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 bg-white/10 hover:bg-white/20 text-white border border-white/25 font-bold text-xs sm:text-sm rounded-lg sm:rounded-xl transition-all duration-300 shadow-sm hover:shadow-md cursor-pointer backdrop-blur-md"
            >
              <span class="w-4 h-4 rounded-full bg-[#f4921e] text-[#001f3b] flex items-center justify-center font-bold shrink-0">
          ...
          <div class="pt-5 sm:pt-6 border-t border-white/20 mt-6 sm:mt-8 space-y-3 sm:space-y-4">
            <div class="grid grid-cols-3 gap-3 sm:gap-6 text-right">
            ...
            <!-- Micro Proof Text -->
            <p class="text-[11px] sm:text-xs text-white/70 font-medium pt-1">
      ...
      <!-- 5. "مسارات الإعمار" Navigation Card (Anchored at Far Top Left) -->
      <div
        dir="rtl"
        class="relative px-4 sm:px-6 mt-6 lg:mt-0 lg:px-0 lg:absolute lg:top-6 lg:left-6 xl:left-10 z-30 flex flex-col items-start"
      >
        <!-- Live Field Tag Pill -->
        <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-black/60 backdrop-blur-md border border-white/20 text-white text-[11px] font-bold shadow-md mb-2">
          <span class="w-1.5 h-1.5 rounded-full bg-[#f4921e] animate-pulse"></span>
          <span>{{ activeSlide.tag }}</span>
        </div>

        <!-- Floating Sidebar Card: "مسارات الإعمار" -->
        <div
          class="w-full max-w-[240px] sm:max-w-[260px] bg-[#fbf9f5]/95 dark:bg-[#08182b]/95 backdrop-blur-md rounded-xl p-2.5 sm:p-3 shadow-xl border border-white/80 dark:border-white/15"
        >
          <!-- Card Header -->
