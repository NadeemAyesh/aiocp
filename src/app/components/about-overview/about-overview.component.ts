...
@Component({
  ...
  template: `
    <section id="about" class="py-16 lg:py-24 relative dark:bg-[#030d1a] transition-colors duration-300">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <!-- About Overview Hero Banner (من نحن • الهيئة في سطور) -->
        <div class="bg-white dark:bg-[#091b2e] rounded-3xl border border-slate-200 dark:border-white/10 shadow-xl overflow-hidden mb-16 lg:mb-20 transition-colors">
        ...
        <!-- 3 Strategic Pillars (Vision, Mission, Objectives) - الرؤية والرسالة والأهداف الاستراتيجية -->
        <div id="vision" class="pt-2">
